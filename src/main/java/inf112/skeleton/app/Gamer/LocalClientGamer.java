...
public class LocalClientGamer extends AbstractGamer {
    private NetworkHandler networkHandler;
    public LocalClientGamer(TiledMap map, String name, int playerNumber, ArrayList<IGamer> gamers, NetworkHandler networkHandler) {
